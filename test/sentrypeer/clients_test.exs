...
defmodule Sentrypeer.ClientsTest do
  ...
  describe "clients" do
    ...
    import Sentrypeer.ClientsFixtures

    @invalid_attrs %{auth_id: nil, client_id: nil}
    ...
    test "create_client/1 with valid data creates a client" do
      valid_attrs = %{auth_id: "some auth_id", client_id: "some client_id"}

      assert {:ok, %Client{} = client} = Clients.create_client(valid_attrs)
      assert client.auth_id == "some auth_id"
    ...
    test "update_client/2 with valid data updates the client" do
      client = client_fixture()
      update_attrs = %{auth_id: "some updated auth_id", client_id: "some updated client_id"}

      assert {:ok, %Client{} = client} = Clients.update_client(client, update_attrs)
      assert client.auth_id == "some updated auth_id"
