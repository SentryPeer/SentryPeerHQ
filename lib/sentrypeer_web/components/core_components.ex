...
defmodule SentrypeerWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: SentrypeerWeb.Gettext
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SentrypeerWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SentrypeerWeb.Gettext, "errors", msg, opts)
    end
  end
  ...
  def being_worked_on(assigns) do
    ...
    <div class="bg-yellow-50 dark:bg-slate-400 p-4 border-b border-gray-200">
      <div class="flex">
        ...
        <div class="ml-3">
          <h3 class="text-sm font-medium text-yellow-800 dark:text-slate-800">Preview</h3>
          <div class="mt-2 text-sm text-yellow-700 dark:text-slate-800">
            <p>
              This data is likely incomplete and being actively worked on. We're doing our best to bring you a great experience, so don't be alarmed if this keeps changing.
            </p>
          </div>
        </div>
      </div>
